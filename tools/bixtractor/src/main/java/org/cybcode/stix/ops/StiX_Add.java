...
public class StiX_Add extends StiXtractorMathDuo implements StiXtractor.Commutative
{
	public StiX_Add(StiXtractor<? extends Number> p0, StiXtractor<? extends Number> p1)
	{
		super(p0, p1);
	}
